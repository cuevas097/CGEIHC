...
//KEYFRAMES DECLARADOS INICIALES
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (horario) {
			if (dia)
			{
				...
				if (nocheCont > 200)
				{
					...
					rtSkybox = "Textures/Skybox/Noche3/sgod_noche3_ft.tga";
					lfSkybox = "Textures/Skybox/Noche3/sgod_noche3_bk.tga";
					dnSkybox = "Textures/Skybox/Noche3/sgod_noche3_dn.tga";
					upSkybox = "Textures/Skybox/Noche3/sgod_noche3_up.tga";
					bkSkybox = "Textures/Skybox/Noche3/sgod_noche3_rt.tga";
					ftSkybox = "Textures/Skybox/Noche3/sgod_noche3_lf.tga";
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(16.0f, -2.0f, 50.0f));
